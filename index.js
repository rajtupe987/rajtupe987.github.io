...
GitHubCalendar(".calendar", "rajtupe987", { responsive: true }); // Display GitHub calendar
// *=============================== resume open in new tab ==================================
    ...
    function NewTab() {
      window.open(
        "https://drive.google.com/file/d/1J1d5qt1F1BJ0R-XB4CNFs8AaIDbaVHJZ/view?usp=sharing",
        "_blank"
      );
    }
